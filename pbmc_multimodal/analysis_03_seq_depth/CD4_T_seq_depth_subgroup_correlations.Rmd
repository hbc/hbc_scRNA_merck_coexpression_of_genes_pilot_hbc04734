---
title: "CD4 T: Sequencing depth effect on correlations"
author: "Noor Sohail"
output:
   html_document:
      code_folding: hide
...
This report look at the CD4 T cells from the PBMC multimodal (RNA + ADT) dataset.
...
To help evaluate the results, I am using a set of control genes that are known to be expressed in CD4 T cells:
